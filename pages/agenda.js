          ...
          <div className="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-100 rounded-b w-full rounded-lg">
            <div className="flex flex-row">
              ...
              <div className="w-full flex flex-row-reverse">
                <FaSearch className="my-4 mx-3 hover:text-[#f7a439] hover:scale-110" />
              </div>
              <div className="bg-gray-200 text-white flex justify-between items-center max-w-[200px] w-full m-auto p-2 rounded-2xl pl-4">
              <div>
