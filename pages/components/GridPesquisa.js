  ...
  return (
    <div className="container mx-auto grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 px-4 gap-4">
      <div className=" p4 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-4 bg-white bg-opacity-20 min-h-full">
          ...
          com documentos, análise foucaultiana do discurso, estudos culturais
          sobre educação, escola, diferença e diversidade.
          <ul>Coordenador(a):</ul>
          <ul>Pesquisadoras(os):</ul>
          <ul>Mestrandas(os):</ul>
          <ul>Egressas(os) da Graduação:</ul>
