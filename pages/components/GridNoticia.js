...
export default function GridNoticia() {
    return (
        <div className="container mx-auto grid md:grid-cols-3 px-4 py-8 gap-4 grid-cols-1">
            
            <div className="bg-gray-300 p4 rounded-lg shadow-md overflow-hidden">
                <div className="w-full bg-gray-200 p-2 border-b border-gray-100">
