...
async function getNoticias() {
  ...
  if (typeof document != "undefined") {
    for (let i = 0; i < 3; i++) {
      ...
      conteudo =
        conteudo.length > 85 ? conteudo.slice(0, 85) + "..." : conteudo; //encurtador de descrição
    ...
    <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 px-4 gap-4">
      <div className="bg-gray-100 p4 rounded-lg shadow-md overflow-hidden">
        <div className="w-full bg-gray-100 p-2 border-b border-gray-100">
          ...
          <a href="/perfil_autor" className="font-thin" id="A1">
            Autor
          </a>
        </div>
        <div>
        ...
        <div className="w-full bg-gray-100 p-2 border-b border-gray-100 pb-3">
          ...
          <p className="text-gray-500 text-end mt-2 text-sm" id="DT1">
            24/06/2022
          </p>
        </div>
      </div>
      <div className="bg-gray-100 p4 rounded-lg shadow-md overflow-hidden">
        <div className="w-full bg-gray-100 p-2 border-b border-gray-100">
          <h4 className="font-semibold text-lg" id="T2">
            Titulo do card
          </h4>
          <a href="/perfil_autor" className="font-thin" id="A2">
            Autor
          </a>
        </div>
        <div >
        ...
        <div className="w-full bg-gray-100 p-2 border-b border-gray-100 pb-3">
          ...
          <p className="text-gray-500 text-end mt-2 text-sm" id="DT2">
            24/06/2022
          </p>
        </div>
      </div>
      <div className="bg-gray-100 p4 rounded-lg shadow-md overflow-hidden">
        <div className="w-full bg-gray-100 p-2 border-b border-gray-100">
          <h4 className="font-semibold text-lg" id="T3">
            Titulo do card
          </h4>
          <a href="/perfil_autor" className="font-thin" id="A3">
            Autor
          </a>
        </div>
        <div>
        ...
        <div className="w-full bg-gray-100 p-2 border-b border-gray-100 pb-3">
          ...
          <p className="text-gray-500 text-end mt-2 text-sm" id="DT3">
            24/06/2022
          </p>
        </div>
      </div>
